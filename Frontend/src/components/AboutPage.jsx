        ...
        <div className="mb-20 relative z-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="glassmorphism-card rounded-2xl p-6 flex items-start space-x-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="glassmorphism-card rounded-2xl p-6">
              ...
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />DFS & BFS Traversals</li>
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Sorting Algorithms</li>
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Dynamic Programming</li>
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Graph Algorithms</li>
              </ul>
            </div>
            <div className="glassmorphism-card rounded-2xl p-6">
              <h3 className="text-xl font-semibold text-white mb-4 flex items-center">
              ...
              <ul className="space-y-3 text-slate-300">
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Step-by-step Tutorials</li>
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Interactive Blogs</li>
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Quick Reference Guides</li>
                <li className="flex items-center"><CheckCircle className="w-5 h-5 mr-3 text-emerald-400" />Practice Problems</li>
              </ul>
            </div>
          </div>
        </div>
