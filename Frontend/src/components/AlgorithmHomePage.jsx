              ...
              >
                ...
                <div className="relative p-8">
                  ...
                  >
                    ...
                    <ChevronRight
                      className={`w-5 h-5 group-hover:translate-x-2 group-hover:${
                        accentClassMap[topic.accent]?.split(" ")[0]
                ...
                <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                  <div
                    className={`w-3 h-3 rounded-full animate-pulse ${
                      accentClassMap[topic.accent]?.split(" ")[1]
                    }`}
                  ></div>
                </div>
              </div>
              ...
              <div className="grid gap-4">
                {modalTopic.algorithms.map((algorithm, index) => (
                  <div
                    ...
                    className={`p-5 rounded-xl border transition-all duration-300 group cursor-pointer relative overflow-hidden ${
